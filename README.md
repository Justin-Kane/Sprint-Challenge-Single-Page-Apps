...
> Answer: without having to wait for the server to respond to our actions, content seems to load faster and the application won’t have to automatically refresh itself when links or buttons are clicked
